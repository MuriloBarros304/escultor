...
void Sculptor::writeOFF(const char *filename){
  ...
  fout << 4 << " " << 0 << " " << 3 << " " << 2 << " " << 1 << " " << std::setprecision(2) << v[0][0][0].r << " " << v[0][0][0].g << " " << v[0][0][0].b << " " << v[0][0][0].a << "\n";
  fout << 4 << " " << 4 << " " << 5 << " " << 6 << " " << 7 << " " << v[0][0][0].r << " " << v[0][0][0].g << " " << v[0][0][0].b << " " << v[0][0][0].a << "\n";
  fout << 4 << " " << 0 << " " << 1 << " " << 5 << " " << 4 << " " << v[0][0][0].r << " " << v[0][0][0].g << " " << v[0][0][0].b << " " << v[0][0][0].a << "\n";
  fout << 4 << " " << 0 << " " << 4 << " " << 7 << " " << 3 << " " << v[0][0][0].r << " " << v[0][0][0].g << " " << v[0][0][0].b << " " << v[0][0][0].a << "\n";
  fout << 4 << " " << 3 << " " << 7 << " " << 6 << " " << 2 << " " << v[0][0][0].r << " " << v[0][0][0].g << " " << v[0][0][0].b << " " << v[0][0][0].a << "\n";
  fout << 4 << " " << 1 << " " << 2 << " " << 6 << " " << 5 << " " << v[0][0][0].r << " " << v[0][0][0].g << " " << v[0][0][0].b << " " << v[0][0][0].a << "\n";
  fout.close();
}
