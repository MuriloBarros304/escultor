...
void Sculptor::writeOFF(const char *filename){
  ...
  for(i=0;i<nx;i++){
    for(j=0;j<ny;j++){
      for(k=0;k<nz;k++){
        if(v[i][j][k].show){ 
          fout << 4 + vf << " " << 0 + vf << " " << 3 + vf << " " << 2 + vf << " " << 1 + vf << " " << 
          v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
          fout << 4 + vf << " " << 4 + vf << " " << 5 + vf << " " << 6 + vf << " " << 7 + vf << " " << 
          v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
          fout << 4 + vf << " " << 0 + vf << " " << 1 + vf << " " << 5 + vf << " " << 4 + vf << " " << 
          v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
          fout << 4 + vf << " " << 0 + vf << " " << 4 + vf << " " << 7 + vf << " " << 3 + vf << " " << 
          v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
          fout << 4 + vf << " " << 3 + vf << " " << 7 + vf << " " << 6 + vf << " " << 2 + vf << " " << 
          v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
          fout << 4 + vf << " " << 1 + vf << " " << 2 + vf << " " << 6 + vf << " " << 5 + vf << " " << 
          v[i][j][k].r << " " << v[i][j][k].g << " " << v[i][j][k].b << " " << v[i][j][k].a << "\n";
          vf += 8;
        }
      }
